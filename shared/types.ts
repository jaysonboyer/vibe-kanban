...
export type ExportPayload = { $schema: string, workspace: ExportWorkspace, task: ExportTask | null, metadata: Record<string, string>, };

export type ExportWorkspace = { id: string, name: string | null, container_ref: string | null, archived: boolean, };

export type ExportTask = { id: string, title: string, description: string | null, description_source: DescriptionSource | null, };

export type DescriptionSource = "local" | "remote";
